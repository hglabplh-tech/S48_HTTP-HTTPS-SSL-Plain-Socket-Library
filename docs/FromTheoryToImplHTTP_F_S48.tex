...
\subsection{The DSL definitions}
\begin{flushleft}
...
\begin{flushleft}
\end{flushleft}
\subsection{The HTTP/HTTPS Client side procedural interface in C / Scheme}
\begin{flushleft}
\end{flushleft}
...
\begin{flushleft}
\end{flushleft}
\subsection{The HTTP/HTTPS Server side procedural interface in C / Scheme}
\begin{flushleft}
\end{flushleft}
